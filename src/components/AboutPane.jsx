  ...
  return (
    <div id="about">
      ...
      <h3 className="content-heading">Our first mode</h3>
        ...
        <p>If user makes A1 and A2 join, he will gets 25% of A1 and A2&apos;s registration fees, and if A1, A2 add B1, B2, B3, B4 user will get 20% of registration fee and A1, A2 will get 25% of B1, B2, B3, B4 registration fee. If B1, B2, B3, B4 add C1, C2, C3, C4, C5, C6, C7, C8 user will get 15% of their registration fee, A1, A2 will get 20% of C1, C2, C3, C4, C5, C6, C7, C8 registration fee and B1, B2, B3, B4 will get 25% of C1, C2, C3, C4, C5, C6, C7, C8 registration fee.</p>
        <div id="tree-wrapper">
          <img src={ tree } alt="" />
