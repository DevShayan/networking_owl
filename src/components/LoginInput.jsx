...
export default function LoginInput() {
  ...
  function onLoginPress() {
    ...
    const isAdminInput = isAdminRef.current.checked;
    ...
    if (!isError) {
      ...
      login(emailInput, passInput, isAdminInput)
        .then(() => {
          ...
          if (user.type == "user")
            ...
            navigate("/admin-dashboard/balance-mod");
        })
        .catch((err) => {
          regBtnRef.current.innerHTML = "Login";
  ...
  return (
    <div id="login-input">
      ...
      <div id="checkbox-wrapper">
        ...
        <input ref={isAdminRef} type="checkbox" id="is-admin" />
      </div>
